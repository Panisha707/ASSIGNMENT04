...
\begin{lstlisting}
https://github.com/Panisha707/ASSIGNMENT04/blob/main/untitled26.py
\end{lstlisting}
%
Question taken from
\begin{lstlisting}
...
\end{align}
\section{Solution}
a) there is no constant in the line equation thus it passes through the origin\\
put $\vec{x}=\myvec{-1\\y}$ in equation
\begin{align}
\myvec{1&1}\myvec{-1\\y}&=0\\
\implies y&=1
\end{align}
\begin{align}
    \vec{P}=\myvec{0\\0},\vec{Q}=\myvec{-1\\1}
\end{align}
b) put $\vec{x}=\myvec{x\\0}$
\begin{align}
